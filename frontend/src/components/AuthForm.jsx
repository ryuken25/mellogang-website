...
export default function AuthForm({ mode }){
  ...
  return <div className="w-full max-w-md"><img src={brand.logo} alt="Mellogang Visuals logo" className="h-16 w-16 rounded-3xl object-cover drop-shadow-[0_0_28px_rgba(244,200,117,.22)]"/><h2 className="mt-6 text-4xl font-semibold tracking-[-.04em] text-cream">{isSignup?'Start your visual story':'Welcome back to Mellogang Visuals'}</h2><p className="subtle mt-3">Book, track, and manage your photo-video production in one cinematic workspace.</p>
