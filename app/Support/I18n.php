    ...
    private static function loadDictionaries(): void
    {
        ...
        self::$dictionaries = [
            self::LANG_EN => [
                ...
                'dashboard.customer.pay'    => 'Pay or track',
                'dashboard.customer.detail' => 'View details',
                'dashboard.customer.recommendedWork' => 'Inspiration for your next shoot',
                'dashboard.customer.viewAll' => 'View all →',
                'dashboard.customer.label.eventDate' => 'Event date',
                'dashboard.customer.label.total'     => 'Total',
                'dashboard.customer.empty'  => 'No bookings yet.',
            ...
            self::LANG_ID => [
                ...
                'dashboard.customer.noOrders'=> 'Belum ada pesanan.',
                'dashboard.customer.browse' => 'Mulai dari katalog',
                ...
                'dashboard.customer.pay'    => 'Bayar atau lacak',
                'dashboard.customer.detail' => 'Lihat detail',
                'dashboard.customer.recommendedWork' => 'Inspirasi untuk shoot berikutnya',
                'dashboard.customer.viewAll' => 'Lihat semua →',
                'dashboard.customer.label.eventDate' => 'Tanggal acara',
                'dashboard.customer.label.total'     => 'Total',
                'dashboard.customer.empty'  => 'Belum ada pesanan.',
